...
const findMaximumSubarrayDAC = (
    ...
    const [leftLow, leftHigh, leftSum] = findMaximumSubarrayDAC(input, low, mid);
    const [rightLow, rightHigh, rightSum] = findMaximumSubarrayDAC(input, mid + 1, high);
